...
contract('SupplyChain', function(accounts) {
    ...
    const originFarmName = "LemonHouse Coffee"
    const originFarmInformation = "Burtonsville"
    const originFarmLatitude = "39.094220"
    const originFarmLongitude = "-76.948610"
    ...
    //Accounts
    //=================
    //(0) 0x61dfB7d0031ba8f3c42730c67f6ba2C0e49547Fc
    //(1) 0xF06cF5226ddc079d23e34Ea172c4Ff41c7468De9
    //(2) 0x7e8D897B32Fc72A1F2ba1Ca8B5607454Df243613
    //(3) 0xBa36531edad0E8AC4aa9EFa600a9C71cF7A2Ba6c
    //(4) 0x63ac12A49423ef48037e0B11E85BAD1d5098c73E
    //(5) 0x18CfbCEA30Dd30a3d3AA007e3b7d7e373A523D49
    //(6) 0x30d25179c2c139F33Fe9BE7973702513aE4e44Fb
    //(7) 0x8042Ce24C6C90905A5402068e2eA8f65eEf0a939
    //(8) 0xD915C3381A97cc41c2AbD71DEeE53D59E0ea5AF3
    //(9) 0xA478985d25f25fa8216121Bf8531706B5B780574

    console.log("Ganache Desktop accounts")
    ...
    // Test
    it("Test roles correctly added to contract", async () => {
    ...
    // 1. Test harvestItem()
    it("Testing function harvestItem() smart contract that allows farmer to harvest coffee", async() => {
        const supplyChain = await SupplyChain.deployed()
    ...
    // 2. Test processItem()
    it("Testing function processItem() smart contract allows a farmer to process coffee", async() => {
        const supplyChain = await SupplyChain.deployed();
    ...
    // 3. Test packItem()
    it("Testing function packItem() smart contract allows a farmer to pack coffee", async() => {
        const supplyChain = await SupplyChain.deployed()
    ...
    // 5. Test buyItem()
    it("Testing function buyItem() smart contract allows a distributor to buy coffee", async() => {
        const supplyChain = await SupplyChain.deployed()
    ...
    // 6. Test shipItem()
    it("Testing function shipItem() smart contract allows a distributor to ship coffee", async() => {
        const supplyChain = await SupplyChain.deployed()
    ...
    // 7. Test receiveItem()
    it("Testing function smart contract receiveItem() allows a retailer to mark coffee received", async() => {
        const supplyChain = await SupplyChain.deployed()
    ...
    // 8. Test purchaseItem()
    it("Testing function purchaseItem() smart contract allows a consumer to purchase coffee", async() => {
        const supplyChain = await SupplyChain.deployed()
    ...
    // 9. Test fetchItemBufferOne()
    it("Testing function fetchItemBufferOne() smart contract allows anyone to fetch item details from blockchain", async() => {
        const supplyChain = await SupplyChain.deployed()
    ...
    // 10. Test fetchItemBufferTwo()
    it("Testing function fetchItemBufferTwo() smart contract that allows anyone to fetch item details from blockchain", async() => {
        const supplyChain = await SupplyChain.deployed()
